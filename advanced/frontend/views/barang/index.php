...
<div class="barang-index">
   ...
   <?= Html::a(Yii::t('yii', 'Import CSV'), ['barang/uploadcsv'], ['class' => 'btn btn-success']) ?>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' '.Yii::t('yii', 'Commodity'),'class'=>'btn btn-outline-primary']).
