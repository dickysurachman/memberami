...
/* @var $searchModel app\models\CostumerSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = \Yii::t('yii', 'Company');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Costumers','class'=>'btn btn-outline-primary']).
