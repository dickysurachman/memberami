...
/**
 * BarangpodetailController implements the CRUD actions for Barangpodetail model.
 */
class BarangpodetailController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all Barangpodetail models.
     * @return mixed
     */
    ...
    /**
     * Displays a single Barangpodetail model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Barangpodetail model.
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Barangpodetail model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the Barangpodetail model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Barangpodetail the loaded model
